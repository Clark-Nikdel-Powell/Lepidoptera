...
function LEPI_scripts() {
	wp_enqueue_script('Settings Switch', plugins_url('/scripts/settings_switch.js' , __FILE__) );
	wp_enqueue_script('Add Foursquare Location', plugins_url('/scripts/add_foursquare_location.js' , __FILE__) );
}
...
<table class="form-table">
	<tr valign="top">
		...
		<td><input type="text" id="facebook_url" name="facebook_url" value="<?php echo get_option('facebook_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">Google+</th>
		<td><input type="text" id="gplus_url" name="gplus_url" value="<?php echo get_option('gplus_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">Linkedin</th>
		<td><input type="text" id="linkedin_url" name="linkedin_url" value="<?php echo get_option('linkedin_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">YouTube</th>
		<td><input type="text" id="youtube_url" name="youtube_url" value="<?php echo get_option('youtube_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">Vimeo</th>
		<td><input type="text" id="vimeo_url" name="vimeo_url" value="<?php echo get_option('vimeo_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">Pinterest</th>
		<td><input type="text" id="pinterest_url" name="pinterest_url" value="<?php echo get_option('pinterest_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">Flickr</th>
		<td><input type="text" id="flickr_url" name="flickr_url" value="<?php echo get_option('flickr_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">Podcast</th>
		<td><input type="text" id="podcast_url" name="podcast_url" value="<?php echo get_option('podcast_url'); ?>" style="width:70%" /></td>
	</tr>
	<tr valign="top">
		<th scope="row">RSS</th>
		<td><input type="text" id="rss_url" name="rss_url" value="<?php echo get_option('rss_url'); ?>" style="width:70%" /><p class="description">Default &rarr; <?php echo get_bloginfo('rss2_url'); ?></p></td>
	</tr>
</table>
...
print($numLocations);
	...
	if ($numLocations != 1):
		...
		<tr valign="top">
			<th scope="row">
				<? //if ( $pointer == 0 ) { ?>Foursquare URL<? // } ?>
				<? if ( ++$i === $numLocations ) { ?><a href="#" class="add_foursquare">Add Location +</a><? } ?>
			</th>
